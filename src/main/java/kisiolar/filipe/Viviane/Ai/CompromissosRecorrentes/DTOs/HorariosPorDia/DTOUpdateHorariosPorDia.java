...
public class DTOUpdateHorariosPorDia {
    ...
    public DTOUpdateHorariosPorDia() {
    }

    public DTOUpdateHorariosPorDia(Long id, DayOfWeek diaDaSemanaInicio, LocalTime horaInicio, DayOfWeek diaDaSemanaFim, LocalTime horaFim, MonthDay inicioDataEspecificaDoAno, MonthDay fimDataEspecificaDoAno, Integer inicioDiaEspecificoMes, Integer fimDiaEspecificoMes) {
        this.id = id;
